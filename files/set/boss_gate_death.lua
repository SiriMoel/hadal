...
function death( damage_type_bit_field, damage_message, entity_thats_responsible, drop_items )
	...
	make_random_card(pos_x + 32, pos_y)
	make_random_card(pos_x, pos_y)
	make_random_card(pos_x - 32, pos_y)

	if EntityGetName(entity_id) == "$animal_gate_monster_a" and GameHasFlagRun("hadalorb08") == false then
		EntityLoad( "data/entities/items/orbs/orb_08.xml", pos_x, pos_y )
		GameAddFlagRun("hadalorb08")
	end
