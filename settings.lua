...
local settings = {
    {
        id = "require_orbs",
        label = "Require Orbs",
        description = "If orbs are required to progress through mountains. Turn off for a significantly easier experience.",
        value_default = true,
    ...
    },
    {
        id = "steve_timer",
        label = "Steve Timer",
        description = "If Steve will spawn if you stay in a Holy Mountain for too long. Turn off for a slighty easier experience.",
        value_default = true,
        scope = MOD_SETTING_SCOPE_RUNTIME,
    },
}
